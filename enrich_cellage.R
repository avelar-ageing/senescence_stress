...
cellage_enrichment_KEGG$enrichment[cellage_enrichment_KEGG$enrichment$ID]
...
cellage_enrichment_GO=cellage_enrichment_KEGG$enrichment[cellage_enrichment_KEGG$
...
cellage_enrichment_just_KEGG=cellage_enrichment_KEGG$enrichment[cellage_enrichment_KEGG$enrichment$enrichment=='KEGG',]
cellage_kegg_no_disease=cellage_enrichment_just_KEGG[cellage_enrichment_just_KEGG$category!='Human Diseases',]
cellage_kegg_no_disease=cellage_kegg_no_disease[!is.na(cellage_kegg_no_disease$category),]

kegg_no_disease=enrichment_dotplot(cellage_kegg_no_disease)

save_p(kegg_no_disease,
       file_name = 'kegg_no_disease',save_dir = save_dir_figure,
       p_width = 11,p_height = 10)
#####
