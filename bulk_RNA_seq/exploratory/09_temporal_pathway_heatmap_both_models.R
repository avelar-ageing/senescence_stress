...
#
# Output: figure_temporal_pathway_heatmap.png
#
# The file this produced has been deleted. chronological-clock decomposition, and pooled over timepoints. Its replacement is named below.
