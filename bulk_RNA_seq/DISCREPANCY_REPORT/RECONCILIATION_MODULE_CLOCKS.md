...
| §7.4 | "No size-matched null yet … not implemented in either arm" | **now implemented in bulk** (`exploratory/12_...py`). Only 72/800 (9%) pass; the "universal core" framing does not survive; melanocyte IFN-α does (d −10.50 vs null q95 5.26, p 0.005) |
